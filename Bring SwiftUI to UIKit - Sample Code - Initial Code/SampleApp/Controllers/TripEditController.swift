...
private extension TripEditController {
   ...
   func textCell(with text: String,
    ...
    func categoryCell(for trip: Trip, indepath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: TripItemTableViewCell.defaultIdentifier, for: indepath)
        cell.contentConfiguration = UIHostingConfiguration {
...
//                return textCell
            ...
            case .category:
                return categoryCell(for: trip, indepath: index)
            }
        }
